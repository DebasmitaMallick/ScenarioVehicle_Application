...
function AllScenarios() {
    ...
    const confirmDelete = () => {
        toast.warning(<DeleteAlert delete = {deleteAllHandler} message = {'Are you sure you want to delete all the scenarios?'} /> , {position: toast.POSITION.TOP_CENTER, closeButton: false});
    }
    ...
    return (
        <>
            <div className='grid-container all-scenario-header'>
                ...
                <div className='grid-item'>
                    <Link className="button blue-btn" to="/addscenario">New Scenario</Link>
                    <Link className="button green-btn" to="/addvehiclesform">Add Vehicles</Link>
                    <div className="button orange-btn" onClick={confirmDelete}>Delete All</div>
                </div>
            </div>
